...
<head>
  ...
  <title>Shot´s | Automatización de Procesos</title>
...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.php"><img src="img/logo.png" alt=""></a>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item active" href="blog-single.php">Automatización de  Procesos</a>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Automatización de Procesos</h1>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="news-img-box">
              <img src="img/imagen1.png " alt="" class="img-fluid">
            </div>
          </div>
          ...
          <div class="col-md-10 offset-md-1 col-lg-10 offset-lg-1">
            ...
            <div class="form-comments">
              <div class="title-box-d">
                <h3 class="title-d"> Cuentanos tu Experiencia</h3>
              </div>
              <form class="form-a">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-lg form-control-a" id="inputName" placeholder="Pedro *" required>
                    </div>
                  </div>
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      <label for="inputEmail1">Correo Electronico</label>
                      <input type="email" class="form-control form-control-lg form-control-a" id="inputEmail1" placeholder="shots@gmail.com *" required>
                    </div>
                  </div>
                  <div class="col-md-12 mb-3">
                    <div class="form-group">
                      <label for="textMessage">Comentario</label>
                      <textarea id="textMessage" class="form-control" placeholder="Tu Opinión *" name="message" cols="45" rows="8" required></textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
