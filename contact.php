        ...
        <ul class="navbar-nav">
          ...
          <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active " href="contact.php">Contactos</a>
              </li>
            </ul>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Contáctenos en: </h1>
              <span class="color-text-a">Toda nuestra información de contacto a su disposición.</span>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="contact-map box">
              <div id="map" class="contact-map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.8750601155016!2d-74.09419858590996!3d4.616367643670061!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f996f784e82a1%3A0xde1500803ab6185c!2sSENA%20Centro%20de%20Dise%C3%B1o%20y%20Metrolog%C3%ADa!5e0!3m2!1ses!2sco!4v1660445075842!5m2!1ses!2sco" width="1100" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        <input type="text" name="name" class="form-control form-control-lg form-control-a" placeholder="Su Nombre" required>
                      </div>
                    </div>
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        <input name="email" type="email" class="form-control form-control-lg form-control-a" placeholder="Su Correo" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea name="message" class="form-control" name="message" cols="45" rows="8" placeholder="Comentario Adicional" required></textarea>
                      </div>
                    </div>
              ...
              <div class="col-md-5 section-md-t3">
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">Correo.
                        <span class="color-a">shotscompany@gmail.com</span>
                      </p>
                      <p class="mb-1">Teléfono.
                        <span class="color-a">+57 304 615 5214</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">
                        Bogotá D.C, Centro de Diseño y Metrología,
                        <br> Colombia
                      </p>
                    </div>
                  </div>
          ...
          <div class="widget-a">
            ...
            <div class="w-body-a">
              <p class="w-text-a color-text-a">
                En Shot's siempre queremos lo mejor para tu empresa,
                que esperas para automatizar tus procesos?
                contactenos en: 
              </p>
            </div>
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Correo.</span> shotscompany@gmail.com
                </li>
                <li class="color-a">
                  <span class="color-text-a">Teléfono.</span> +57 304 615 5214
                </li>
              </ul>
            </div>
          </div>
              ...
              <div class="w-body-a">
                <ul class="list-unstyled">
                  <li class="item-list-a">
                    <i class="bi bi-chevron-right"></i> <a href="#">Mapa del Sitio</a>
                  </li>
                  <li class="item-list-a">
                    <i class="bi bi-chevron-right"></i> <a href="#">Deja tu Opición</a>
                  </li>
                  <li class="item-list-a">
                    <i class="bi bi-chevron-right"></i> <a href="#">Redes Sociales</a>
                  </li>
                  <li class="item-list-a">
                    <i class="bi bi-chevron-right"></i> <a href="#">Afiliate con Nosotros</a>
                  </li>
                </ul>
              </div>
            </div>
